...
describe("state versioning", () => {
  ...
  it("should remove the completion polling interval when upgrading from 8 to 9", () => {
    testMigration<State_8>(
      {
        settings: {
          connection: {
            protocol: "https",
  ...
  it("should drop the cached tasks when upgrading from 9 to 10", () => {
