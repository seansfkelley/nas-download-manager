...
This section explains what each permission requested by NAS Download Manager is used for. You can find the list of requested permissions in [`manifest.json`](https://github.com/seansfkelley/nas-download-manager/blob/main/manifest.json), under the `permissions` and `host_permissions` sections.

| human-readable name                                                               | source code name                                  | explanation                                                                                                                                                                                                                                                                                                                                           |
| --------------------------------------------------------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Access your data for all websites / Read and change all your data on all websites | `http://*/*` and `https://*/*` (host permissions) | Used to talk to your NAS and to run the content script that supports the feature where left-clicking on supported link types automatically adds a download, rather than opening it in a browser tab. See [issue #45](https://github.com/seansfkelley/nas-download-manager/issues/45) for more on replacing that implementation with something better. |
| Display notifications to you                                                      | `notifications`                                   | Used to display addition/completion/error notifications (if enabled).                                                                                                                                                                                                                                                                                 |
| _n/a_                                                                             | `alarms`                                          | Used to periodically check for completions in the background to support the send-notification-on-download-complete feature (if enabled).                                                                                                                                                                                                              |
...
Host permissions are the only ones that are granted separately from installation, and your browser lets you narrow or revoke them. If you restrict site access to only the host your NAS is on, the extension will still be able to manage your downloads, but left-clicking download links on other sites will no longer add them automatically.
