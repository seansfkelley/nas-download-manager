...
const ERROR_CODES: Record<string, Record<string, string>> = {
  ...
  Auth: {
    ...
    406: browser.i18n.getMessage("Twostep_verification_is_enforced_for_this_account"),
    407: browser.i18n.getMessage("Blocked_IP_source"),
    408: browser.i18n.getMessage("Expired_password_cannot_be_changed"),
    409: browser.i18n.getMessage("Expired_password"),
    410: browser.i18n.getMessage("Password_must_be_changed"),
  } as Record<string, string>,
